...
class ContentBlockTest extends TestCase
{
    ...
    public function test_admin_without_site_permissions_cannot_update_content_blocks(): void
    {
    ...
    public function test_admin_with_section_permission_can_update_matching_block(): void
    {
        $content = ['en' => ['badge' => 'Permitted'], 'ar' => ['badge' => 'مسموح']];

        $token = User::factory()->create([
            'role' => 'admin',
            'admin_site_permissions' => ['hero'],
        ])->createToken('test')->plainTextToken;
